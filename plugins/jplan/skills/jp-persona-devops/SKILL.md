...
Infrastructure and CI/CD conventions, quality gates, and domain knowledge. Loaded by the jp-worker-dev agent when handling DevOps tasks. This is not a user-invocable skill.

...
Frontend and UI conventions, quality gates, and domain knowledge. Loaded by the jp-worker-dev agent when handling frontend tasks. This is not a user-invocable skill.
